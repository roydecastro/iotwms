            ...
            <form id="sales-form">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select  id="type" name="type" class="custom-select select2">
                            <option value="1" <?php echo isset($type) && $type == 1 ? "selected" : "" ?>>Earn Points</option>
                            <option value="2" <?php echo isset($type) && $type == 2 ? "selected" : "" ?>>Redeem Points</option>
                        </select>
                ...
                <div class="row align-items-end">
                    <div class="form-group col-sm-4">
                        <label class="control-label">Trash Type</label>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select  id="status" name="status" class="custom-select">
                        <option value="0" <?php echo isset($status) && $status == 0 ? "selected" : "" ?>>Earn</option>
                        <option value="1" <?php echo isset($status) && $status == 1 ? "selected" : "" ?>>Redeem</option>
                    </select>
                </div>
            </form>
        </div>
...
<script>
    ...
    $(function(){
       ...
       $('#add_to_list').click(function(){
            ...
            if(jar_type_id == ''){
                alert_toast(' Please Select Trash Type first',"warning");
                return false;
            }
            if(quantity <= 0){
            ...
            tr.append("<td class='text-center'><input type='hidden' name='quantity[]' value='"+quantity+"'>"+(parseFloat(quantity).toLocaleString("en-US"))+" grams</td>")
