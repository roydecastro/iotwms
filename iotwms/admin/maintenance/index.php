...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List of Trash Points</h3>
...
<script>
	...
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i>Add New Trash Type & Points",'maintenance/manage_jar_type.php');
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i>Edit Trash Type & Points",'maintenance/manage_jar_type.php?id='+$(this).attr('data-id'));
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Trash Type & Points?","delete_jartype",[$(this).attr('data-id')])
		})
	})
